...
--
-- Name: tb_order fkr570bk7cs29h2gdhdfpoad4yd; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_order
    ADD CONSTRAINT fkr570bk7cs29h2gdhdfpoad4yd FOREIGN KEY (clientid) REFERENCES public.tb_user(id);
